...
const ContactSection = () => {
  return (
    <div className="w-full flex justify-center items-left py-16 px-4">
      <div
        className="w-full max-w-5xl min-h-[320px] rounded-2xl p-10 text-white flex items-center justify-left bg-center bg-no-repeat shadow-[6px_6px_10px_rgba(0,0,0,0.6)]"
        style={{
